...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-1788-schanuel-s-conjecture-482075a6-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-1788"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-1788-schanuel-s-conjecture-482075a6-v1",
      "problem_contract_sha256": "34dea44cf7a5d7fa52796b3f38c44116111e4bd6bde9f255529b0432f9fb3d36",
      "problem_id": "problem:um-opg-1788-schanuel-s-conjecture-482075a6",
      "route_id": "route:um-opg-1788-schanuel-s-conjecture-482075a6-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-1788-schanuel-s-conjecture-482075a6-source-fidelity-01",
      "graph_id": "graph:um-opg-1788-schanuel-s-conjecture-482075a6-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-1788-schanuel-s-conjecture-482075a6-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-1788-schanuel-s-conjecture-482075a6-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture Given any $n$ complex numbers $z_1,...,z_n$ which are linearly independent over the rational numbers $\\mathbb{Q}$, then the extension field $\\mathbb{Q}(z_1,...,z_n,\\exp(z_1),...,\\exp(z_n))$ has transcendence degree of at least $n$ over $\\mathbb{Q}$."
          },
          "statement_sha256": "baf91c862cfa424511513868e8ea96ed5a8dea0a00eb5bc5055a4cc5973c0a8b"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-1788-schanuel-s-conjecture-482075a6-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-1788-schanuel-s-conjecture-482075a6-root",
      "route_id": "route:um-opg-1788-schanuel-s-conjecture-482075a6-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-1788-76f3cebf80c0",
        "url": "https://www.unsolvedmath.com/problems/OPG-1788"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
